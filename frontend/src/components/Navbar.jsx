        ...
        >
          ...
          <button onClick={() => go('home')} className="flex items-center gap-2 group flex-none pl-1">
            <div className="relative">
             ...
             <img src={BRAND.logo} alt="iDesign4U logo" className="relative w-14 h-14 lg:w-16 lg:h-16 object-contain rounded-lg group-hover:rotate-6 transition-transform" />
            </div>
